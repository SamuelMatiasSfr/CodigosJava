...
class JogoPainel extends JPanel implements Runnable {
	...
	public JogoPainel() {
		...
		setFocusable(true);
		Movel.getInstancia().setParametros(new Dimension(30, 30), 100, 300, 10, 0, Color.RED);
		Movel.getInstancia().setParametros(null, null, null, null, null, null);
	}
	...
	public void paintComponent(Graphics g) {
		...
		Movel.getInstancia().paintComponent(g);
	}
...
class Movel {
    ...
    public static Movel getInstancia(){
        if(movel == null){
            movel = new Movel();
        }
        return movel;
